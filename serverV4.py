...
# - Robust camera connect with auto-detect (falls back to first detected port)
# - /cameras to list ports, /set_camera to pick one (GET or POST)
# - /api/health and /api/diag for quick debugging
# - /capture returns {"url", "serverPath"}; /confirm, /return_live manage state
#
# ENV:
